<template>
    <v-container class="pa-0 fill-height" fluid>
        ...
        <v-card height="100%" width="100%" tile>
            ...
            <div class='pa-0 ma-0' style="display: flex; flex-wrap：nowrap; height:100%">
                <div style="height:100%; width:32%; min-width:32%;">
                    <v-col>
                ...
                <div
                    style=" display: flex; height:100%; width:2%; min-width:2%; justify-content:center;align-items:center">
                    <v-tooltip top>
                ...
                <div style="display: flex; height:100%; width:32%; min-width:32%;">
                    <v-col>
                        <v-sheet class="pa-0 pt-1">
                            <v-row class="pa-0 ma-0">
                                <v-col cols="12" class="ma-0 pa-0">
                ...
                <div style=" width:32%; min-width:32%;">
                    <v-col>
                        <v-sheet class="pa-0 pt-1">
                            <v-row class="pa-0 ma-0">
                                <v-col cols="12" class="ma-0 pa-0">
